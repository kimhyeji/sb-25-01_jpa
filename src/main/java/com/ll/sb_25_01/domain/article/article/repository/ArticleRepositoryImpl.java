...
import com.ll.sb_25_01.domain.article.articleComment.entity.QArticleComment;
import com.ll.sb_25_01.domain.article.articleTag.entity.QArticleTag;
import com.ll.sb_25_01.domain.member.member.entity.QMember;
...
public class ArticleRepositoryImpl implements ArticleRepositoryCustom{
    ...
    public Page<Article> search(List<String> kwTypes, String kw, Pageable pageable) {
        ...
        */
        ...
        /*
        # 전체 게시물 수 구하기, 검색어가 1 인 경우, COUNT(DISTINCT A.id) 사용
